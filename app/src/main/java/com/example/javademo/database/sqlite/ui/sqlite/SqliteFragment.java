package com.example.javademo.database.sqlite.ui.sqlite;
...
public class SqliteFragment extends Fragment {
    ...
    private SqliteViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(SqliteViewModel.class);
